  ...
  return (
    <Router>
      <div className="flex flex-col min-h-screen">
        <header className="bg-gradient-to-r from-green-800 to-blue-500 text-white p-4 text-center">
          <h1 className="text-3xl">CP2 - RESPONSIVE WEB DEVELOPMENT</h1>
        </header>
        <nav>
        ...
        <footer className="bg-gradient-to-r from-green-800 to-blue-500 text-white p-4 text-center">
          <p className="text-2xl">© 2024 Marco Aurelio Morais Ennes | RM: 553201 - 1TDSZ - Github: https://github.com/Marcoaurelio31/</p>
        </footer>
